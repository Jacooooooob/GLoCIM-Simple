...
class PreNewsEncoder(nn.Module):
    ...
    def forward(self, news_input, mask=None):
        ...
        #print("title_word_emb的维度是：{}".format(title_word_emb.shape))
        #print("category_emb的维度是：{}".format(category_emb.shape))
        #print("subcategory_emb的维度是：{}".format(subcategory_emb.shape))
